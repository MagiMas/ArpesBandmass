...
"}")
        ...
        self.WDGT_ARPES.setMinimumSize(QtCore.QSize(400, 300))
        ...
        self.RB_Lorentzian = QtWidgets.QRadioButton(self.centralWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.RB_Lorentzian.sizePolicy().hasHeightForWidth())
        self.RB_Lorentzian.setSizePolicy(sizePolicy)
        self.RB_Lorentzian.setObjectName("RB_Lorentzian")
        self.buttonGroup_3 = QtWidgets.QButtonGroup(MainWindow)
        self.buttonGroup_3.setObjectName("buttonGroup_3")
        self.buttonGroup_3.addButton(self.RB_Lorentzian)
        self.verticalLayout_3.addWidget(self.RB_Lorentzian)
        self.RB_Gaussian = QtWidgets.QRadioButton(self.centralWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.RB_Gaussian.sizePolicy().hasHeightForWidth())
        self.RB_Gaussian.setSizePolicy(sizePolicy)
        self.RB_Gaussian.setObjectName("RB_Gaussian")
        self.buttonGroup_3.addButton(self.RB_Gaussian)
        self.verticalLayout_3.addWidget(self.RB_Gaussian)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.RB_Lorentzian.setText(_translate("MainWindow", "Lorentzian"))
